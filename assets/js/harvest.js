...
$('body').on('click', 'a.finalize-btn', function() {
    let plant = this.getAttribute('data-plant');
    let gen = plant.split("_")[1];
    let plant_id = plant.split("_")[2];
    const detail = JSON.stringify({
